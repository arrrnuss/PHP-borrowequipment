...
<div class="modal fade" id="userModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="accept.php" method="post" enctype="multipart/form-data" >
        <div class="row">
        <h2 class="display-5 text-center">คำขอยืม</h2>
            <div class="col-md-6">
        ...
        <table id="example"  class="table table-hover table-bordered table-dark" cellspacing="0" width="100%">
            ...
            <th width="10%"><h5>Code</th>
                    ...
                    <th width="10%"><h5>User</th>
                    <th width="10%"><h5>dates</th>
                    <th width="10%"><h5>datee</th>
                    <th width="10%"><h5>Img</th>
                    <th width="10%"><h5>status</th>
                    <th width="25%"><h5>Actions</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                    $stmt = $conn->query("SELECT * FROM request WHERE status = 'request' ");
                    $stmt->execute();
                    $item = $stmt->fetchAll();
                ...
                ?>
                     <tr class="table-secondary">
                        ...
                        <td>    
                        <div class="mb-3">
                        <a  href="form_ac.php?id=<?php echo $items['id']; ?>" class="btn btn-success">ยอมรับการยืม</a>
                        </div>
                        </td>
                    </tr>
                <?php }  } ?>
